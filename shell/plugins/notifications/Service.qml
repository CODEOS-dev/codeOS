...
Item {
  ...
  //   - app_name is "omarchy-action" (codeOS's own user-action toasts —
  ...
  // Run the popup's click action, then dismiss. codeOS's own toasts carry the
  ...
  function replayHistory(raw) {
    ...
    if (rows.length === 0) {
      popupModel.insert(0, {
        ...
        app: "omarchy-action",
        appIcon: "",
        summary: I18n.t("notifications.no_recent"),
        body: "",
        image: "",
        glyph: "󰂚",
        execArgv: "",
