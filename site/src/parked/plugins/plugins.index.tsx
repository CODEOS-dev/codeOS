...
export const Route = createFileRoute('/plugins/')({
  ...
  head: () =>
    seo({
      title: 'Plugins - codeOS',
      description:
        'The community marketplace for codeOS Quattro plugins. Inspect the source, copy the command, and shape your shell around the way you work.',
      path: '/plugins/',
    }),
