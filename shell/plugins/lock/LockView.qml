...
Item {
  ...
  readonly property string placeholderText: "请输入密码"
  ...
  Rectangle {
    ...
    BorderSurface {
      ...
      Text {
        ...
        text: root.authenticatingPassword ? I18n.t("lock.checking") : (root.failureMessage.length > 0 ? root.failureMessage : root.placeholderText)
