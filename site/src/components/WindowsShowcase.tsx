  ...
  return (
    <>
      <SectionHeading
        ...
        description={t(
          "Keep the Windows apps you need, right inside codeOS. Our Windows 11 VM setup makes room for native Microsoft Office and the other programs you can't leave behind.",
        )}
      />
      <img
      ...
      <div className="mt-6 grid gap-6 md:grid-cols-3 lg:gap-8">
        <div>
          ...
          <p className="mt-3 text-[15px] leading-relaxed text-text-secondary">
            ...
            {t(
              'from the codeOS menu. Hardware virtualization brings near-native CPU performance for Office and everyday work, with a shared clipboard and a folder for moving files between Windows and Linux.',
            )}
          </p>
        </div>
        <div>
