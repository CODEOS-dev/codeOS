...
This is the Quickshell implementation of the codeOS status bar. It is
...
- `Bar.qml` is codeOS-owned bar engine code, loaded by the omarchy-shell host. Users should not edit it directly.
...
|---|---|---|
| `omarchy.menu` | codeOS menu launcher | left = menu · right = terminal |
