...
const features = [
  {
    ...
    description: t(
      'On first boot, codeOS invites you to set up a default agent. Pick your favorite, sign in, and put it to work on your computer.',
    ),
  },
  {
  ...
  },
  {
    ...
    description: t(
      'codeOS ships with skills to help your agent make apps, plugins, and themes. Describe what you want, try what it builds, and share it with everyone.',
    ),
  },
]
  ...
  return (
    <>
      <SectionHeading
        ...
        description={t(
          'Your agent should feel at home on your computer. codeOS gives it the tools and skills to help you understand, fix, and shape the whole system.',
        )}
      />
