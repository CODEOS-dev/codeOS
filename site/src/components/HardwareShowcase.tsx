...
const examples = [
  {
    ...
    description: t(
      'Ready for something new? Laptops like the latest Dell XPS make amazing codeOS machines, with our core team helping the newest hardware work properly.',
    ),
    icon: DisplayIcon,
    href: '/news/2026/09/the-codeOS-core-team/',
    link: t('Meet the team behind it'),
  },
  {
    title: t('Vintage Macs'),
    description: t(
      'Give that old Intel Mac a second life. codeOS brings a fresh desktop to the hardware you already love.',
    ),
    icon: AppleIcon,
  ...
  },
  {
    title: t('Potato PCs'),
    description: t(
      'Even a 2011 ThinkPad X220 with 2GB of RAM can run codeOS, with room to spare. Your old PC might have plenty left to give.',
    ),
    icon: DisplayIcon,
    href: '/potato/',
  ...
  return (
    <>
      <SectionHeading
        ...
        description={t(
          "You don't need a new machine to try codeOS. But if you get one, today's laptops are amazing.",
        )}
      />
