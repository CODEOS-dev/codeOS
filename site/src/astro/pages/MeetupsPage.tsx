...
const CALENDAR_URL = 'https://luma.com/codeOS'
      ...
      <PageHeading title={t('Meetups')}>
        <div className="mx-auto mt-3 max-w-2xl text-center">
          <p className="text-[15px] leading-relaxed text-text-secondary [text-wrap:pretty]">
            {t(
              'codeOS meetups are popping up around the world. Find one near you, or start one. They all live on the codeOS calendar on Luma.',
            )}
          </p>
