...
export const Route = createFileRoute('/plugins/develop')({
  ...
  head: () =>
    seo({
      title: 'Develop a Plugin - codeOS',
      description:
        'Build a custom codeOS Quattro plugin: clone a built-in, edit a working example, and validate the finished folder against the manifest rules.',
