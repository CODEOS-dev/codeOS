...
const columns = [
  {
    ...
    links: [
      ...
      { label: t('Plugins'), href: 'https://plugins.codeOS.org' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'GitHub', href: 'https://github.com/omacom/codeOS' },
      { label: t('Brand'), splat: 'brand' },
      {
        label: t('Merch'),
        href: 'https://supply.37signals.com/collections/codeOS',
      },
    ],
  },
] as const
    ...
    >
      ...
      <div className="footer-rise relative mx-auto max-w-6xl px-4 py-14 sm:px-6">
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-border-subtle pt-6 text-[13px] text-text-muted sm:flex-row sm:items-center sm:justify-between">
          ...
          <p data-quiet>
            {t('Partner inquiries:')}{' '}
            <a href="mailto:foundation@codeOS.org" className={footerLink}>
              foundation@codeOS.org
            </a>
          </p>
        </div>
      </div>
