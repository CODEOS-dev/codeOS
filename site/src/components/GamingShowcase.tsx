...
const games = [
  {
    ...
    alt: t('Steam showing its game store on codeOS'),
    section: 'steam',
    description: t(
      'Your PC gaming library, right at home on Linux. Steam and Proton bring a huge world of modern games to codeOS.',
    ),
  },
  {
    name: 'RetroArch',
  ...
  },
  {
    ...
    alt: t('Minecraft running on codeOS'),
    section: 'minecraft',
    description: t(
      'Build, explore, and make a world of your own. Install Minecraft straight from the codeOS gaming menu and let your imagination run.',
    ),
  },
]
  ...
  return (
    <>
      <SectionHeading
        ...
        description={t(
          'codeOS comes ready for Steam, RetroArch, and a whole world of gaming. Graphics drivers and configuration, including NVIDIA on supported hardware, are sorted during installation.',
        )}
      />
