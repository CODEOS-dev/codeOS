...
description: >
  ...
  Covers reporting a confirmed codeOS bug upstream — see reporting.md.
---
...
## If it is an codeOS bug

Most application crashes are upstream bugs in those applications, not codeOS's
doing. In the minority of cases where the cause really does sit within codeOS's
