...
export function ThemePicker() {
  ...
  // The entry point is T. codeOS's own chord still works for anyone not on
  // codeOS, but on codeOS itself Hyprland binds it at the compositor and
          ...
          >
            ...
            <span>
              ...
              <span className="mt-1 block text-[13px] leading-relaxed text-text-secondary">
                {t(
                  'Press T, or tap here. Inside codeOS it is Super + Ctrl + Shift + Space.',
                )}
              </span>
            </span>
          </button>
