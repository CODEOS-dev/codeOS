...
Item {
  ...
  property string placeholderText: I18n.t("search.placeholder")
  property string emptyText: I18n.t("search.no_options")
  property string noSelectionText: I18n.t("search.none_selected")
