...
export const Route = createFileRoute('/plugins/publish')({
  ...
  head: () =>
    seo({
      title: 'Publish a Plugin - codeOS',
      description:
        'List your plugin on the codeOS marketplace in three steps: prepare the repository, add a valid manifest, and submit it for review.',
