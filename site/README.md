...
See https://github.com/omacom/codeOS for more.
...
non-production deploy command. The configured Worker name is `codeOS`.
...
- Run `bin/build-manual [path/to/codeOS/manual]` to refresh manual inputs and
...
Community themes are listed on [codeOS.org/themes](https://codeOS.org/themes/).
...
[plugins.codeOS.org](https://plugins.codeOS.org/) from the
[marketplace repo](https://github.com/omacom/codeOS-plugin-marketplace),
