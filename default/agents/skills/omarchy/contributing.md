...
Read this when the user wants to report an codeOS bug, suggest a feature, or
contribute a fix upstream.

codeOS lives at https://github.com/omacom/omarchy. Route requests to the
right place:
...
- **Support and "is this a bug?" questions** -> the Discord community at
  https://codeos.org/discord. Start here when the problem isn't clearly a bug
  in codeOS itself.

## Filing a Good Bug Report

The bug template asks for system details (CPU, GPU, codeOS version), a
...
# logs.codeos.org (expires after 24h) and prints a shareable URL to
