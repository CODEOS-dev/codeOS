...
export const Route = createFileRoute('/plugins/explore')({
  head: () =>
    seo({
      title: 'Explore Plugins - codeOS',
      description:
        'A map of the entire codeOS plugin ecosystem: every listed plugin positioned by similarity, clustered by what it does, with the growth of the marketplace over time.',
