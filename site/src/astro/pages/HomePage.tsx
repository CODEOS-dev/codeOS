...
const TRY = {
  mac: {
    label: t('Try on Mac'),
    href: 'https://github.com/omacom/try-codeOS',
    icon: AppleIcon,
  },
  windows: {
    label: t('Try on Windows'),
    href: 'https://github.com/omacom/try-codeOS-windows',
    icon: WindowsIcon,
  },
} as const
...
const videos = [
  {
    id: 'F7fe9pa8OeE',
    title: 'codeOS Quattro by David Heinemeier Hansson',
    channel: 'DHH',
    thumb: 'https://codeOS.org/assets/images/video/codeOS-quattro.webp',
  },
  {
    id: '9SDkU5VDQEQ',
    title: 'You need to switch to Linux RIGHT NOW!!',
    channel: 'NetworkChuck',
    thumb: 'https://codeOS.org/assets/images/video/networkchuck.webp',
  },
  {
    id: '5JPYJfN7HY0',
    title: 'They finally fixed linux',
    channel: 'typecraft',
    thumb: 'https://codeOS.org/assets/images/video/typecraft.webp',
  },
  {
    id: 'qBKMe8AatY0',
    title: "I Didn't Expect codeOS 4 to Be This Good",
    channel: 'LinuxBTW',
    thumb: 'https://codeOS.org/assets/images/video/linuxbtw.webp',
  },
  {
    id: 'KO2T0oET9go',
    title: 'If you use AI, switch to codeOS immediately',
    channel: 'Alex Finn',
    thumb: 'https://codeOS.org/assets/images/video/alex-finn.webp',
  },
  {
    id: '2IDjteRQgMQ',
    title: 'codeOS Can Do WHAT?! 50 Features You’re Missing',
    channel: 'NetworkChuck',
...
const communityCards = [
  ...
  },
  {
    ...
    title: t('Meetups'),
    body: t(
      'codeOS meetups are popping up around the world. Find one near you, or start one.',
    ),
    to: '/meetups/',
    cta: t('Find a meetup'),
  },
  {
    ...
    href: 'https://github.com/omacom/codeOS',
  ...
  },
  {
    ...
    title: t('Donate'),
    body: t(
      'Help fund the people and projects making codeOS better for everyone.',
    ),
    href: 'https://donate.codeOS.org',
...
export function HomePage({ data }: { data: HomeData }) {
  ...
  useEffect(() => {
    if (!sessionStorage.getItem('codeOS-intro-seen')) {
      sessionStorage.setItem('codeOS-intro-seen', 'true')
      setIntro(true)
    }
  }, [])

  const allPlugins = (
    <a href="https://plugins.codeOS.org" className={sectionLink}>
      {t('All plugins')}
      <ArrowRightIcon />
    </a>
  )
  ...
  const moreOnX = (
    <a
      href="https://x.com/search?q=codeOS&f=live"
      target="_blank"
    ...
    <main>
                ...
                <>
                  <span className="block">
                    <SectionAnchor anchor="home">
                      <span className="sr-only">codeOS: </span>
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:py-28">
          <div className="grid gap-8 lg:grid-cols-[1.35fr_1fr] lg:gap-20">
            <div>
              ...
              >
                {t(
                  'Linux used to be a chore to setup, difficult to debug, and full of confusing upfront choices. codeOS solves all of it with a lightning fast installation, agents that debug all issues, and fantastic defaults that give you a fully functioning system that looks amazing out of the box.',
                )}
              </p>
              <p
              ...
              >
                {t(
                  "Oma is for omakase, chef's choice: the chef picks the courses, but you are always free to send anything back. codeOS lets you take an exquisite baseline and then make it your own.",
                )}
              </p>
          ...
          <div className="mt-6 lg:mt-10 grid gap-4 md:grid-cols-2">
            <div className="@container ring-elevation flex min-w-0 flex-col bg-surface p-6">
              ...
              <div className="mt-auto pt-6">
                ...
                >
                  <DownloadIcon data-icon="inline-start" />
                  {t('Download codeOS')} {release.version}
                </Button>
            ...
            <div className="ring-elevation flex min-w-0 flex-col bg-surface p-6">
              ...
              <p className="mt-3 text-[15px] leading-relaxed text-text-secondary [text-wrap:pretty]">
                {t(
                  'All of codeOS running in a virtual machine, so you can get a taste first.',
                )}
              </p>
              <div className="mt-auto pt-6">
      ...
      <section id="plugins" className="border-t border-border-subtle">
        <div className="mx-auto max-w-6xl px-4 py-12 lg:py-24 sm:px-6">
          <SectionHeading
            ...
            description={t(
              "Thousands of community plugins are available for codeOS. Don't find what you need? Just put your agent on the job, then share when done.",
            )}
            action={allPlugins}
          />
      ...
      <section id="teams" className="border-t border-border-subtle bg-bg-deep">
        <div className="mx-auto max-w-6xl px-4 py-12 lg:py-24 sm:px-6">
          <SectionHeading
            ...
            description={t(
              'codeOS Core sets the direction, the Security team keeps your system safe, Design shapes how it looks and feels, and the Rangers help others find their way.',
            )}
            action={allTeams}
          />
          <TeamClusters />
      ...
      <section id="patrons" className="border-t border-border-subtle">
        <div className="mx-auto max-w-6xl px-4 py-12 lg:py-24 sm:px-6">
          <SectionHeading
            ...
            description={t(
              "The billionaires, mere millionaires, and corporations funding the lion's share of the development, maintenance, and spread of codeOS.",
            )}
            action={allPatrons}
          />
          <PatronHighlights />
      ...
      <section id="community" className="border-t border-border-subtle">
        <div className="mx-auto max-w-6xl px-4 py-12 lg:py-24 sm:px-6">
          <SectionHeading
            anchor="community"
            title={t('Get involved with codeOS')}
            description={t(
